	...
	<div className='header section__padding' id='inicio'>
		<div className='header-content'>
			<h1 className='gradient__text'>
				Únete a la mejor academia de trading de latinoamérica
			</h1>
			<p>
				Aprende a operar como un trader de clase mundial en distintos mercados
				financieros. Recibe señales ganadoras para incremetar tus ganancias.
				Conoce la mejor estrategia para realizar trading institucional. Sé parte
				de las mejores clases en vivo para poner en práctica tus conocimientos.
			</p>
